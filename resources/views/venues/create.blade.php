...
@section('title', 'サウナ・銭湯を投稿する - ' . config('app.name'))
@section('description', '地図をタップして場所を選び、サウナ・銭湯の名称・住所などを投稿できます。ログイン不要・匿名で投稿可能です。')

@section('content')
<div class="container my-4">
  <h1 class="h4 mb-3">➕ サウナ・銭湯を投稿する</h1>
  ...
  <form method="POST" action="{{ route('venues.store') }}" class="bg-light p-3 rounded shadow-sm">
    ...
    <button type="submit" class="btn btn-sauna w-100">登録する</button>
  </form>
</div>
@endsection
